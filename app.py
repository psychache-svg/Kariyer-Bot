...
calculate_subdomain_scores,
scores_to_feature_dict,
...
create_interest_pie_chart,
create_work_style_bar_chart,
create_cluster_donut_chart
)
from modules.reports import simple_student_report
from modules.pdf_export import save_markdown_report
st.set_page_config(
page_title="Kariyer Keşif Robotu",
page_icon="🧭",
layout="wide"
)
