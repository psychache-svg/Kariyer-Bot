...
from modules.scoring import calculate_subdomain_scores, scores_to_feature_dict, response_quality_checks
from modules.decision_engine import load_json, calculate_cluster_scores, attach_confidence, detect_uncertainties, get_top_clusters
from modules.charts import create_interest_pie_chart, create_work_style_bar_chart, create_cluster_donut_chart
from modules.reports import simple_student_report
from modules.pdf_export import save_markdown_report
st.set_page_config(page_title="Kariyer Keşif Robotu", page_icon="🧭", layout="wide")
ITEMS_PATH = "data/items.csv"
CAREER_CLUSTERS_PATH = "data/career_clusters.json"
...
elif st.session_state.step == "intro_chat":
...
elif st.session_state.step == "micro_tasks":
...
elif st.session_state.step == "calculate_results":
...
elif st.session_state.step == "development_plan":
